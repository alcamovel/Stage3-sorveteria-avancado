...
O projeto Space Cream foi desenvolvido para estudar o uso do HTML e do CSS responsivo para mobile. Neste projeto, construimos uma aplicação para uma sorveteria. Entre os temas mais comuns estão:
